...
// void get_process_info(int pid, uid_t target_uid) {
//     char path[256];
//     char line[512];
//     FILE *fp;
//     uid_t uid;
...
//     // CPU usage simplifikasi: hanya tampilkan 0 karena butuh lebih kompleks (delta time, uptime, dll)
//     // Tambahkan jika butuh: baca dari /proc/stat dan /proc/[pid]/stat lalu hitung delta

//     printf("PID: %-6d CMD: %-20s CPU: %.2f%% MEM: %.2f KB\n", pid, comm, cpu_usage, mem_usage);
// }
